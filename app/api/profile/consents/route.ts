...
// Zod schema for the expected consent object in the request body
const ConsentUpdateSchema = z.object({
  // Example: Assuming consents are stored as a JSON object
  emailMarketing: z.boolean().optional(),
  productUpdates: z.boolean().optional(),
  researchParticipation: z.boolean().optional(),
  // Add other consent flags as needed
})
